...
#untuk mengsetting lebar dan panjang layar
#pemberian nama/judul output saat di running
WIDTH, HEIGHT = 400, 400
pygame.display.set_caption('Smooth Movement')

pygame.init()#berfungsi untuk memulai game
win = pygame.display.set_mode((WIDTH, HEIGHT)) #Memanggil nilai HIGHT dan Widht
clock = pygame.time.Clock()#untuk mengatur waktu animasi pada object


#untuk mengubah tampilan warna 
BLACK = (0, 0, 0)
WHITE = (255, 255, 255)
RED = (255, 0, 0)
GREEN = (229, 204, 255)
...
font_obj = pygame.font.Font("Archistico_Bold.TTF",23)
#Tulisan akan muncul di layar
text = "Alfida Sofiya Mufti"
